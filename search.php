				...
				<div class="postbox-details-wrapper">
					...
					?>
						<div class="result-bar page-header d-none">
							<h1 class="page-title"><?php esc_html_e('Search Results For:', 'saasty'); ?> <?php print get_search_query(); ?></h1>
						</div>
						<?php
						...
						<div class="basic-pagination basic-pagination-2 mb-40">
							<?php saasty_pagination('<i class="fas fa-angle-double-left"></i>', '<i class="fas fa-angle-double-right"></i>', '', ['class' => '']); ?>
						</div>
					<?php
					else:
