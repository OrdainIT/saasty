...
if (!class_exists('TGM_Plugin_Activation')) {
    ...
    class TGM_Plugin_Activation
    {
        ...
        public function init()
        {
            ...
            // Load class strings.
            $this->strings = array(
                'page_title'                      => __('Install Required Plugins', 'saasty'),
                'menu_title'                      => __('Install Plugins', 'saasty'),
                /* translators: %s: plugin name. */
                'installing'                      => __('Installing Plugin: %s', 'saasty'),
                /* translators: %s: plugin name. */
                'updating'                        => __('Updating Plugin: %s', 'saasty'),
                'oops'                            => __('Something went wrong with the plugin API.', 'saasty'),
                ...
                'return'                          => __('Return to Required Plugins Installer', 'saasty'),
                'dashboard'                       => __('Return to the Dashboard', 'saasty'),
                'plugin_activated'                => __('Plugin activated successfully.', 'saasty'),
                'activated_successfully'          => __('The following plugin was activated successfully:', 'tgmpa'),
                /* translators: 1: plugin name. */
                'plugin_already_active'           => __('No action taken. Plugin %1$s was already active.', 'saasty'),
                /* translators: 1: plugin name. */
                'plugin_needs_higher_version'     => __('Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'saasty'),
                /* translators: 1: dashboard link. */
                'complete'                        => __('All plugins installed and activated successfully. %1$s', 'saasty'),
                'dismiss'                         => __('Dismiss this notice', 'saasty'),
                'notice_cannot_install_activate'  => __('There are one or more required or recommended plugins to install, update or activate.', 'saasty'),
                'contact_admin'                   => __('Please contact the administrator of this site for help.', 'saasty'),
            );
