...
<header>
    <!-- header-area-start -->
    <div id="header-sticky" class="it-header-area p-relative ss-header-style it-header-transparent it-header-ptb" style="background-color: <?php echo esc_attr($field_header_bg_color, 'saasty'); ?>">
        <div class="container">
                ...
                <?php if (!empty($header_right_switcher)): ?>
                    <div class="col-xxl-2 col-xl-3 col-6">
                        <div class="it-header-right-action d-flex justify-content-end align-items-center">
                            <?php if (!empty($header_right_switcher)): ?>
                                <a href=" <?php echo esc_url($header_right_btn_url, 'saasty'); ?>" class="ss-btn d-none d-lg-block">
