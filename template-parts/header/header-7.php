...
<header>
    <!-- header-area-start -->
    <div id="header-sticky" class="ai-header-style p-relative seo-header-style it-header-area pg-header-style dt-header-style it-header-transparent it-header-ptb" style="background-color: <?php echo esc_attr($field_header_bg_color, 'saasty'); ?>">
        <div class="container">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-6">
                        <div class="it-header-right-action d-flex justify-content-end align-items-center">
                            ...
                            <?php if (!empty($header_right_btn_switcher)): ?>
                                <a href=" <?php echo esc_url($header_right_btn_url, 'saasty'); ?>" class="cr-btn white-bg hover-2 d-none d-lg-block">
