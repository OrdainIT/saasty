...
$header_right_btn_text = get_theme_mod('header_right_btn_text', __('Contact Us', 'saasty'));
$header_right_btn_url = get_theme_mod('header_right_btn_url', __('#', 'saasty'));



$header_right_remove_container = $header_right_switcher ? 'col-xl-7 d-none d-xl-block' : 'col-xl-10 d-none d-xl-block text-end';
$header_right__sidebarmenu = $header_right_switcher ? 'd-none  col-xl-3 col-lg-6 col-md-6 col-6' : 'd-sm-block d-none d-xl-none col-xl-3 col-lg-6 col-md-6 col-6';
