...
<header>
   <!-- header-area-start -->
   <div id="header-sticky" class="it-header-area dt-header-style p-relative it-header-transparent it-header-ptb" style="background-color: <?php echo esc_attr($field_header_bg_color, 'saasty'); ?>">
      <div class="container">
                        ...
                        <?php if (!empty($header_right_search_icon_switcher)): ?>
                           <button class="search-open-btn">
                              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M8.6 16.2C12.7974 16.2 16.2 12.7974 16.2 8.6C16.2 4.40264 12.7974 1 8.6 1C4.40264 1 1 4.40264 1 8.6C1 12.7974 4.40264 16.2 8.6 16.2Z" stroke="#01103D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M17.0004 17.0004L15.4004 15.4004" stroke="#01103D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
                           </button>
                        <?php endif; ?>
                        <?php if (!empty($header_right_btn_login_switcher)): ?>
                           <a class="border-line-black" href="<?php echo esc_url($header_right_login_btn_url, 'saasty'); ?>"><?php echo esc_html($header_right_login_btn_text, 'saasty'); ?></a>
                        <?php endif; ?>
                     </div>

                     <a href="<?php echo esc_url($header_right_btn_url, 'saasty'); ?>" class="it-btn theme-2-bg d-none d-lg-block">
