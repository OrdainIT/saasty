...
<header>
    <!-- header-area-start -->
    <div id="header-sticky" class="ag-header-style p-relative it-header-area dt-header-style it-header-transparent it-header-ptb" style="background-color: <?php echo esc_attr($field_header_bg_color, 'saasty'); ?>">
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-6">
                        <div class="it-header-right-action d-flex justify-content-end align-items-center">
                            <?php if (!empty($header_right_btn_login_switcher)): ?>
                                <div class="it-header-search-box mr-25">
                                    <a class="border-line-white d-none d-md-block" href="<?php echo esc_url($header_right_login_btn_url, 'saasty'); ?>"><?php echo esc_html($header_right_login_btn_text, 'saasty'); ?></a>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($header_right_btn_switcher)): ?>
                                <a href="<?php echo esc_url($header_right_btn_url, 'saasty'); ?>" class="ag-btn d-none d-lg-block">
                ...
                <?php endif; ?>
                <div class="<?php echo esc_attr($header_right__sidebarmenu, 'sassty'); ?>">
                    <div class="it-header-right-action d-flex justify-content-end align-items-center">
                        <div class="it-header-bar d-xl-none">
                            <button class="it-menu-bar">
                                <span>
