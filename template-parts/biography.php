<?php
    ...
    $author_info = get_the_author_meta( 'saasty_write_by');
    $facebook_url = get_the_author_meta( 'saasty_facebook' );
    $twitter_url = get_the_author_meta( 'saasty_twitter' );
    $linkedin_url = get_the_author_meta( 'saasty_linkedin' );
    $instagram_url = get_the_author_meta( 'saasty_instagram' );
    $saasty_url = get_the_author_meta( 'saasty_youtube' );
    $saasty_write_by = get_the_author_meta( 'saasty_write_by' );
