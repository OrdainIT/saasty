...
if (is_single()): ?>
   ...
   <article id="post-<?php the_ID(); ?>" <?php post_class('postbox-item format-gallery'); ?>>
      <?php if (!empty($gallery_images)): ?>
         <div class="it-postbox-wrapper p-relative mb-35">
...
<?php else: ?>
   ...
   ?>
      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class('"col-xl-4 col-lg-4 col-md-6 mb-30 format-gallery'); ?>>
         <div class="it-blog-item p-relative">
            <?php if (!empty($gallery_images)): ?>
               <div class="it-postbox-wrapper mb-30 p-relative">
                  <div class="swiper-container postbox-thumb-slider-active">
                     <div class="swiper-wrapper">
                        <?php foreach ($gallery_images as $key => $image): ?>
                           <div class="swiper-slide">
   ...
   ?>
      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class('postbox-thumb-box mb-60 format-gallery'); ?>>
         <?php if (!empty($gallery_images)): ?>
            <div class="it-postbox-wrapper mb-30 p-relative">
               <div class="swiper-container postbox-thumb-slider-active">
                  <div class="swiper-wrapper">
