...
if (is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox-item format-image'); ?>>
...
<?php else: ?>
    ...
    ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class('"col-xl-4 col-lg-4 col-md-6 mb-30 format-image'); ?>>
    ...
    ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class('postbox-thumb-box mb-60 format-image'); ?>>
            <?php if (has_post_thumbnail()): ?>
